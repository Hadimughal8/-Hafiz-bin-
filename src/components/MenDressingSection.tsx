...
import { MEN_PRODUCTS, Product } from '../data/products';
import { motion } from 'motion/react';
import { Sparkles, Eye } from 'lucide-react';

interface MenDressingSectionProps {
  onSelectProduct: (product: Product) => void;
}

export const MenDressingSection: React.FC<MenDressingSectionProps> = ({ onSelectProduct }) => {
  return (
    <section id="men-dressing" className="py-20 bg-[#0e0e0e] relative">
          ...
          {MEN_PRODUCTS.map((product, idx) => (
            ...
            >
              ...
              <div className="relative h-80 overflow-hidden bg-black">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#0e0e0e] via-black/30 to-transparent opacity-80 group-hover:opacity-90 transition-opacity" />
              ...
              {/* Animated Gold Bottom Border Glow */}
